...
const Skipe = () => {
  ...
  >
    <Box sx={style1}>
      ...
      <Form.Label>Skip nom d'utilisateur</Form.Label>
      <Form.Control
      type='text'
    />
    </Form.Group>
  ...
  <Table sx={{ minWidth: 650}} size="small" aria-label="a dense table">
    <TableHead>
      <TableRow>
        ...
        <TableCell align="right" style={{color:"#7C858C"}}>Skipe Nom d'utilisateur <UnfoldMoreIcon fontSize="small"/></TableCell>
    ...
    <TableBody>
        ...
        >
          <Box sx={style1}>
            ...
            <Form.Group className="mb-3">
            <Form.Label>Skipe nom d'utilisateur</Form.Label>
            <Form.Control
            type="text"
          />
          </Form.Group>
